function [superVoxelCells] = splitHardSuperVoxels_kmeansNB(splitHardSVopts, superVoxelCells, bbVol)
...
while ~isempty(hardSuperVoxels)
    ...
    fprintf('\nIteration %d complete. %d hard supervoxels left to split out of %d total superVoxels.\n',iterCount,newSVcount,numel(superVoxelCells));
