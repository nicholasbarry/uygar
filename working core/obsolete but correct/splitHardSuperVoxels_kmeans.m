function [L, superVoxelCells] = splitHardSuperVoxels_kmeans(splitHardSVopts, superVoxelCells, bbVol)
...
while ~isempty(hardSuperVoxels) & flag
  ...
  superVoxelCells(hardSuperVoxels(subdividedSuperVoxels)) = []; % delete supervoxels greater than SizeThreshold
  ...
  fprintf('\nStarted with %d supervoxels.\n',prevSVcount);
  fprintf('\nIdentified %d hard supervoxels needing splitting.\n',numel(subdividedSuperVoxels));
  fprintf('\n%d supervoxels were created in that split.\n',newSVcount)
  fprintf('\nNew total of %d supervoxels.\n',numel(superVoxelCells));
